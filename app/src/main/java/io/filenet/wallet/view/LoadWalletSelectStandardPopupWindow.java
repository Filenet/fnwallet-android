...
public class LoadWalletSelectStandardPopupWindow extends PopupWindow implements OnClickListener {
    ...
    public LoadWalletSelectStandardPopupWindow(Context context) {
        ...
        tvJaxx = contentView.findViewById(R.id.tv_standard_jaxx);
        tvJaxx.setSelected(true);
        tvLedger = contentView.findViewById(R.id.tv_standard_ledger);
        tvCustom = contentView.findViewById(R.id.tv_standard_custom);
        ivJaxx = contentView.findViewById(R.id.iv_standard_jaxx);
        ivLedger = contentView.findViewById(R.id.iv_standard_ledger);
        ivCustom = contentView.findViewById(R.id.iv_standard_custom);
        setProperty();
    }
